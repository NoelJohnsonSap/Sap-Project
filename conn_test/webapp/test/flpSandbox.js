		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comapplexusconntest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexusconntest-display": {
								"semanticObject": "comapplexusconntest",
								"action": "display",
								"description": "A Fiori application to check connectivity",
								"title": "Connectivity Test",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.conntest",
									"url": sap.ui.require.toUrl("com/applexus/conntest")
								}
							}
						}
					}
