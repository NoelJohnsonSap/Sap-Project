		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Simple Form1",
									"targetURL": "#comapplexussimpleform1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexussimpleform1-display": {
								"semanticObject": "comapplexussimpleform1",
								"action": "display",
								"description": "Simple Form 1",
								"title": "Simple Form1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.simpleform1",
									"url": sap.ui.require.toUrl("com/applexus/simpleform1")
								}
							}
						}
					}
