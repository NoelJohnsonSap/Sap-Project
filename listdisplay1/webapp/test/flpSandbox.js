		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List Display of Fruits",
									"targetURL": "#comapplexuslistdisplay1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexuslistdisplay1-display": {
								"semanticObject": "comapplexuslistdisplay1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.listdisplay1",
									"url": sap.ui.require.toUrl("com/applexus/listdisplay1")
								}
							}
						}
					}
