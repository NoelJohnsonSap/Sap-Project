		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sample App",
									"targetURL": "#comapplexusmysampleapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexusmysampleapp-display": {
								"semanticObject": "comapplexusmysampleapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.mysampleapp",
									"url": sap.ui.require.toUrl("com/applexus/mysampleapp")
								}
							}
						}
					}
