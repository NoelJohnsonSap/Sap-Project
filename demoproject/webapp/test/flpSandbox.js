		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Foodielink",
									"targetURL": "#comapplexusdemoproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexusdemoproject-display": {
								"semanticObject": "comapplexusdemoproject",
								"action": "display",
								"description": "Foodielink",
								"title": "Foodielink",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.demoproject",
									"url": sap.ui.require.toUrl("com/applexus/demoproject")
								}
							}
						}
					}
