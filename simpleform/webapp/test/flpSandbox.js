		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Simple Form",
									"targetURL": "#comapplexussimpleform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexussimpleform-display": {
								"semanticObject": "comapplexussimpleform",
								"action": "display",
								"description": "Application to perform DataBinding in Simple Form ",
								"title": "Simple Form",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.simpleform",
									"url": sap.ui.require.toUrl("com/applexus/simpleform")
								}
							}
						}
					}
