		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Calculator",
									"targetURL": "#comapplexuscalculator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexuscalculator-display": {
								"semanticObject": "comapplexuscalculator",
								"action": "display",
								"description": "A Fiori app for a calculator",
								"title": "Calculator",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.calculator",
									"url": sap.ui.require.toUrl("com/applexus/calculator")
								}
							}
						}
					}
