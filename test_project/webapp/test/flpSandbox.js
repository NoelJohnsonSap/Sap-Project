		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Test App",
									"targetURL": "#comtesttestproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtesttestproject-display": {
								"semanticObject": "comtesttestproject",
								"action": "display",
								"description": "Test App For Tranning",
								"title": "Test App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.test.testproject",
									"url": sap.ui.require.toUrl("com/test/testproject")
								}
							}
						}
					}
