		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Calculator",
									"targetURL": "#comapplexuscalculator1test-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexuscalculator1test-display": {
								"semanticObject": "comapplexuscalculator1test",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.calculator1test",
									"url": sap.ui.require.toUrl("com/applexus/calculator1test")
								}
							}
						}
					}
