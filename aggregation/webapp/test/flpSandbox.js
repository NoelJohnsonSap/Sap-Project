		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Table Display",
									"targetURL": "#comapplexusaggregation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexusaggregation-display": {
								"semanticObject": "comapplexusaggregation",
								"action": "display",
								"description": "grid Display : Dynamic Table",
								"title": "Table Display",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.aggregation",
									"url": sap.ui.require.toUrl("com/applexus/aggregation")
								}
							}
						}
					}
